...
def cerberus_urlpatterns(admin_view_func=lambda x: x):
    ...
    return [
        ...
        # url(r'^permissions/user/edit/json/$',
        #     admin_view_func(views.jsoninfouser),
        #     name='edit_user_permissions_json'),
        ...
        # url(r'^permissions/group/edit/json/$',
        #     admin_view_func(views.jsoninfogroup),
        #     name='edit_group_permissions_json'),
