...
urlpatterns = [
    ...
    url(r'^permissions/group/edit/$', views.editgrouppermpost, name='edit_group_permissions_post'),
    ...
    url(r'^permissions/user/view/(?P<user>[0-9]+)/$', views.edituserpermpost, name='edit_user_permissions_post'),
    url(r'^permissions/user/view/(?P<user>[0-9]+)/$', views.edituserperm, name='edit_user_permissions'),
