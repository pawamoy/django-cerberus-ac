...
Cerberus Access Control could always use more documentation, whether as part of the
official Cerberus Access Control docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
.. [1] If you don't have all the necessary python versions available locally you can rely on Travis - it will
       `run the tests <https://travis-ci.org/Deavelleye/dj-CerberusAC/pull_requests>`_ for each change you add in the pull request.
